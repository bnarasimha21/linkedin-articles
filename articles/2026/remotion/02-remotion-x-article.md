...
The workflow is natural. I describe what I want. Claude generates the component, handles frame calculations, sets up animations.
...
I tell Claude how long each segment is, where captions should appear, when transitions should hit.
